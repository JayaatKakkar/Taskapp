...
<div class=" row mt-3 pt-2 pb-2 bg-white" id="emplodiv">
    <div class="col-sm-9 text-center align-self-center"><h6>Brands</h6></div>
    ...
    <div class="collapse" id="emps">
        <form id="brandfrom" class="needs-validation" novalidate method="post" enctype="multipart/form-data">

            <div class="row  ">
                <div class="col-sm-6 mt-3 form-floating">
                    <input type="text" name="brand_name" id="brand_name" placeholder="Category Name" class="form-control">
                    <label for="brand_name" class=" ms-2">Brand Name</label>
                </div>


                <div class="col-sm-6 mt-3 form-floating">
                    <textarea class="form-control" id="descr" name="descr" placeholder="Enter details"></textarea>
                    <label for="descr" class=" ms-2">Brand Description</label>
                </div>
            </div>
...
<div class="row">
    ...
    <div class="col-sm-6 mt-3 form-floating">
        <input type="text" name="since" id="since" placeholder="Category Name" class="form-control">
        <label for="since" class=" ms-2">Brand Since</label>
    </div>
    <div class="col-sm-6 mt-3 form-floating">
        <input type="text" name="tagline" id="tagline" placeholder="Category Name" class="form-control">
        <label for="tagline" class=" ms-2">Brand Tagline</label>
    </div>
